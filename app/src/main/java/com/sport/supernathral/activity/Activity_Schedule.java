...
public class Activity_Schedule extends AppCompatActivity {
    ...
    String access_date,end_date_str,from;
    ArrayList<HashMap<String,String>> schedule_ArrayList;
    String newString, today,newDate,main_access_group_id,sub_access_group_id;;
    ...
    public void initView(){
        ...
        ll_start_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(Activity_Schedule.this, datePickerListener3, mYear, mMonth, mDay).show();
            }
        });
        ll_end_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(Activity_Schedule.this, datePickerListener1, mYear, mMonth, mDay).show();
            }
        });
                ...
                if (response != null){
                    ...
                    try {
                        ...
                        if (status == 1){
                            ...
                            adapterSchedule
                                    = new AdapterSchedule(Activity_Schedule.this, schedule_ArrayList,from);
                            ...
                            FancyToast.makeText(Activity_Schedule.this, message,
                        ...
                        FancyToast.makeText(Activity_Schedule.this, "Connection error",
