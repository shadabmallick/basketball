...
public class AttendenceStudentList extends AppCompatActivity {
    ...
    public void initView(){
        ...
        if(datechange.equals("previous")){
            ll_late.setClickable(false);
            ll_present.setClickable(false);
            ll_excuse.setClickable(false);
            ll_absent.setClickable(false);
        }
        else {
            ll_present.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    type="present";
                    AddAttendnceList(type,formattedDate);
                }
            });
            ll_excuse.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    type="excuses";
                    AddAttendnceList(type,formattedDate);
            ...
            ll_absent.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    type="absent";
                    AddAttendnceList(type,formattedDate);
            ...
            ll_late.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    type="late";
                    AddAttendnceList(type,formattedDate);
                ...
                if (response != null){
                    ...
                    try {
                        ...
                        if (status == 1){
                            ...
                            adapterNotes
                                    = new AdapterAttendence(AttendenceStudentList.this, schedule_ArrayList);
                            ...
                            FancyToast.makeText(AttendenceStudentList.this, message,
    ...
    private void AddAttendnceList(final String type,final String date) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                ADD_ATTENDENCE, new Response.Listener<String>() {
                    ...
                    try {
                        ...
                        if (status == 1){
                            ...
                            for (int i = 0; i < news_data.length(); i++) {
                                ...
                                String player_id = item.get("player_id").toString().replaceAll("\"", "");
                                String schedule_id = item.get("schedule_id").toString().replaceAll("\"", "");
            ...
            protected Map<String, String> getParams() {
                ...
                Log.d(TAG, " ADD ATTENDENCE "+params);
                return params;
            }
